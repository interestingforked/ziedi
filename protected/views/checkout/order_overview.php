        ...
        <table id="cart" cellpadding="0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo number_format($item['item']['subtotal'], 2,'.','').Yii::app()->params['currency']; ?></td>
                </tr>
                <?php endforeach; ?>
                <tr>
                    <td style="padding-top:20px;" colspan="5"><?php echo Yii::t('app', 'Products price'); ?>:</td>
                    <td style="padding-top:20px;"><?php echo number_format($price, 2,'.','').Yii::app()->params['currency']; ?></td>
                </tr>
                <?php if ($discount): ?>
                <tr>
                    ...
                    if ($discountType == 'percentage')
                        ...
                        echo number_format($discount, 2,'.','').Yii::app()->params['currency']; 
                    ?></td>
                </tr>
                <?php endif; ?>
                <tr>
                    <td style="padding-top:9px;padding-bottom:8px;" colspan="5"><?php echo Yii::t('app', 'Shipping'); ?>:</td>
                    <td style="padding-top:9px;padding-bottom:8px;"><?php echo number_format($shipping, 2,'.','').Yii::app()->params['currency']; ?></td>
                </tr>
                <tr>
                    <td style="padding-bottom:20px;padding-top:8px;" colspan="5"><?php echo Yii::t('app', 'Total sum of order'); ?>:</td>
                    <td style="padding-bottom:20px;padding-top:8px;border-top:solid 1px #ccc;"><?php echo number_format($totalPrice, 2,'.','').Yii::app()->params['currency']; ?></td>
                </tr>
            </tbody>
        </table>
