...
foreach ($products as $product):
    ...
    if ($attachetImage) {
        $image = CHtml::image(Image::thumb(Yii::app()->params['images'].$attachetImage->image, 220), $product->content->title);
    } else {
        $image = CHtml::image(Image::thumb('/images/fl1.jpg', 220), $product->content->title);
    }
?>
        <td class="border">
