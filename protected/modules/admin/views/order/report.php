<div class="block">
    ...
    <div class="block_content">
        ...
        <table cellpadding="0" cellspacing="1" width="100%">
            <tr>
                <td><?php echo CHtml::textField('start_date', $orderStartDate, array('class' => 'text date_picker')); ?></td>
                <td><?php echo CHtml::textField('end_date', $orderEndDate, array('class' => 'text date_picker')); ?></td>
                <td><?php echo CHtml::dropDownList('status', $orderStatus, $orderStatuses, array('class' => 'styled small')); ?></td>
                <td><?php echo CHtml::submitButton('Filter', array('class' => 'submit small')); ?></td>
            </tr>
        </table>
