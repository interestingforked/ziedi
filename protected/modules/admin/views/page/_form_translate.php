...
<p>
    ...
    <select name="Page[parent_id]" id="Page_parent_id" class="styled big" disabled="disabled">
...
<p>
    ...
    <?php echo $form->textField($pageModel,'slug', array('class' => 'text medium', 'disabled' => 'disabled')); ?>
...
<p>
    ...
    <?php echo $form->textField($pageModel,'sort', array('class' => 'text tiny', 'disabled' => 'disabled')); ?>
    <span class="note error"><?php echo $form->error($pageModel, 'sort'); ?></span>
&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
    <?php echo $form->checkBox($pageModel, 'active', array('class' => 'checkbox', 'disabled' => 'disabled')); ?>
...
<p>
    ...
    <?php echo $form->dropDownList($pageModel, 'plugin', $plugins, array('class' => 'styled', 'disabled' => 'disabled')); ?>
