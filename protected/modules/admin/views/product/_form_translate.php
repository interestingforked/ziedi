...
<p>
    <span style="display:block;float:left;width:300px;">
        ...
        echo Chtml::listBox('Categories[]', null, $categories,
                array('id' => 'categories', 'size' => 6, 'style' => 'width:300px;', 'multiple' => 'multiple', 'disabled' => 'disabled')); 
        ?>
    </span>
    <span style="display:block;float:left;width:100px;text-align:center;padding-top:30px;">
    &nbsp;<?php echo Chtml::button('     >>     ', array('name' => 'categories2selected_categories', 'class' => 'select_buttons', 'disabled' => 'disabled')); ?>
    <br/>
    <?php echo Chtml::button('     <<     ', array('name' => 'selected_categories2categories', 'class' => 'select_buttons', 'disabled' => 'disabled')); ?>
    </span>
    <span style="display:block;float:left;width:300px;">
        <?php
        echo Chtml::listBox('SelectedCategories[]', null, $activeCategories,
                array('id' => 'selected_categories', 'size' => 6, 'style' => 'width:300px;', 'multiple' => 'multiple', 'disabled' => 'disabled')); 
        ?>
    </span>
</p>
<p>
...
<p>
    ...
    <?php echo $form->textField($model,'slug', array('class' => 'text medium', 'disabled' => 'disabled')); ?>
