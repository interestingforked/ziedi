...
class CategoryController extends AdminController {
    ...
    public function actionTranslate($id) {
        $this->pageTitle = 'Categories / Translate category';
        ...
        $categoryModel = Category::model()->findByPk($id);
        $contentModel = Content::model()->getModuleContent('category', $id, 'ru');
    ...
    public function actionMoveD($id) {
        ...
        $maxModel = Category::model()->findBySql(
                "SELECT MAX(sort) as sort FROM categories WHERE parent_id = :parent_id", array(':parent_id' => $model->parent_id)
        );
